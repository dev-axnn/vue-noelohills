<template>
  <!-- CATEGORY -->
    <section class="category">
      <div class="inner">
        <div class="category-img"><a href="#" class="category-link wb2">BABY</a></div>
        ...
        <div class="category-img"><a href="#" class="category-link wb2">FAMILY</a></div>
        <div class="category-img"><a href="#" class="category-link wb2">BATH GOODS</a></div>
        <div class="category-txt">
          <p class="category-desc">
        ...
        <div class="category-img"><a href="#" class="category-link wb2">PRESENTS</a></div>
      </div>
    </section>
</template>

      ...
      <div class="mb-wrap">
        <ul class="mb-menu">
          <li v-for="(item, index) in mbmenu" v-bind:key="index">
            <span class="mb-mainmenu" v-if="item.tagtype == 'span'">{{item.mainmenu}}</span>
            <a :href="item.mainlink" class="mb-mainmenu" v-if="item.tagtype == 'a'">{{item.mainmenu}}</a>
            <ul class="mb-submenu" v-if="item.tagtype == 'span'">
